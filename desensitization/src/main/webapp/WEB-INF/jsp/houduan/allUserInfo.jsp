      ...
      <%--<div class="layui-row">--%>
        <%--&lt;%&ndash;<form class="layui-form layui-col-md12 x-so">&ndash;%&gt;--%>
          ...
          <%--&lt;%&ndash;&lt;%&ndash;<div class="layui-input-inline">&ndash;%&gt;&ndash;%&gt;--%>
            <%--&lt;%&ndash;&lt;%&ndash;<select name="contrller">&ndash;%&gt;&ndash;%&gt;--%>
              <%--&lt;%&ndash;&lt;%&ndash;<option>支付状态</option>&ndash;%&gt;&ndash;%&gt;--%>
              <%--&lt;%&ndash;&lt;%&ndash;<option>已支付</option>&ndash;%&gt;&ndash;%&gt;--%>
              <%--&lt;%&ndash;&lt;%&ndash;<option>未支付</option>&ndash;%&gt;&ndash;%&gt;--%>
            <%--&lt;%&ndash;&lt;%&ndash;</select>&ndash;%&gt;&ndash;%&gt;--%>
          <%--&lt;%&ndash;&lt;%&ndash;</div>&ndash;%&gt;&ndash;%&gt;--%>
          <%--&lt;%&ndash;&lt;%&ndash;<div class="layui-input-inline">&ndash;%&gt;&ndash;%&gt;--%>
            <%--&lt;%&ndash;&lt;%&ndash;<select name="contrller">&ndash;%&gt;&ndash;%&gt;--%>
              <%--&lt;%&ndash;&lt;%&ndash;<option value="">用户状态</option>&ndash;%&gt;&ndash;%&gt;--%>
              <%--&lt;%&ndash;&lt;%&ndash;<option value="0">待确认</option>&ndash;%&gt;&ndash;%&gt;--%>
              <%--&lt;%&ndash;&lt;%&ndash;<option value="1">已确认</option>&ndash;%&gt;&ndash;%&gt;--%>
              <%--&lt;%&ndash;&lt;%&ndash;<option value="2">已收货</option>&ndash;%&gt;&ndash;%&gt;--%>
              <%--&lt;%&ndash;&lt;%&ndash;<option value="3">已取消</option>&ndash;%&gt;&ndash;%&gt;--%>
              <%--&lt;%&ndash;&lt;%&ndash;<option value="4">已完成</option>&ndash;%&gt;&ndash;%&gt;--%>
              <%--&lt;%&ndash;&lt;%&ndash;<option value="5">已作废</option>&ndash;%&gt;&ndash;%&gt;--%>
            <%--&lt;%&ndash;&lt;%&ndash;</select>&ndash;%&gt;&ndash;%&gt;--%>
          <%--&lt;%&ndash;&lt;%&ndash;</div>&ndash;%&gt;&ndash;%&gt;--%>
          <%--&lt;%&ndash;&lt;%&ndash;<input type="text" name="username"  placeholder="请输入订单号" autocomplete="off" class="layui-input">&ndash;%&gt;&ndash;%&gt;--%>
          <%--&lt;%&ndash;&lt;%&ndash;<button class="layui-btn"  lay-submit="" lay-filter="sreach"><i class="layui-icon">&#xe615;</i></button>&ndash;%&gt;&ndash;%&gt;--%>
        <%--&lt;%&ndash;</form>&ndash;%&gt;--%>
      <%--</div>--%>
      <xblock>
        <%--<button class="layui-btn" onclick="x_admin_show('添加用户','${pageContext.request.contextPath}/user/addUserJSP.action')"><i class="layui-icon"></i>添加</button>--%>
      </xblock>
