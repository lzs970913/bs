...
<div class="padding-all">
    ...
    <div class="design-w3l">
        <div class="mail-form-agile">
            ...
            <form action="${pageContext.request.contextPath}/login/regist.action" method="post" id="loginform">
                <input type="text" name="name"class="padding" placeholder="User Name  or  email..." required=""/>
                <input type="password"  name="password" class="padding" placeholder="Password" required=""/>
                <input type="text" name="gender" class="padding"  placeholder="请输入性别" required=""/>
                <input type="text"  name="age" class="padding" placeholder="请输入年龄" required=""/>
