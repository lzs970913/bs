  ...
  <body>
    ...
    <div class="x-body">
      ...
      <%--</div>--%>
        ...
        <table class="layui-table" lay-data="{width: 1000, height:332, url:'${pageContext.request.contextPath}/order/getAllOrderByUserId.action', page:true, id:'idTest'}" lay-filter="demo">
          <thead>
          <tr>
            <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
            <th lay-data="{field:'id', width:80, sort: true, fixed: true}">订单编号</th>
            <th lay-data="{field:'roomName', width:80}">预定房间名</th>
            <th lay-data="{field:'orderStartData', width:80, sort: true}">订单开始时间</th>
            <th lay-data="{field:'orderEndData', width:80}">订单结束时间</th>
            <th lay-data="{field:'orderStatus', width:160}">订单状态</th>
            <th lay-data="{field:'userName', width:80}">预定人</th>
            <th lay-data="{fixed: 'right', width:178, align:'center', toolbar: '#barDemo'}"></th>
          </tr>
          </thead>
        </table>
      <script type="text/html" id="barDemo">
        <a class="layui-btn layui-btn-xs" lay-event="edit">添加评论</a>
            ...
            table.on('tool(demo)', function(obj){
                ...
                if(obj.event === 'detail'){
                    ...
                    layer.open({
                        ...
                        ,content: '${pageContext.request.contextPath}/comments/addCommentsJSP/'+data.id+'.action'
                        ,yes: function(){
                            $(this).click();
                        }
                        ,btn2: function(){
