...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="index.index.jsp">民宿管理系统</a></div>
        <div class="left_open">
      ...
      <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/order/getAllOrderByUserIdJSP.action">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>我的订单</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/room/getAllRoomInfoUserJSP.action">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看所有房源信息</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/comments/getAllCommentsUserJSP.action">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看评论</cite>
                        </a>
                    ...
                    <li>
                        <a _href="${pageContext.request.contextPath}/order/myOrderAddComments.action">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加评论</cite>
                        </a>
