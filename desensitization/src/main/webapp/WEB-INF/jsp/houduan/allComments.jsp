...
<html>
  ...
  <body>
    ...
    <div class="x-body">
      ...
      <table class="layui-table" lay-data="{width: 1000, height:332, url:'${pageContext.request.contextPath}/comments/getAllComments.action', page:true, id:'idTest'}" lay-filter="demo">
        <thead>
        <tr>
          <th lay-data="{field:'id', width:120, sort: true, fixed: true}">评论编号</th>
          <th lay-data="{field:'commentsRoom', width:140}">评论房间名</th>
          <th lay-data="{field:'commentUser', width:160, sort: true}">评论人</th>
          <th lay-data="{field:'description', width:200}">评论内容</th>
            ...
            table.render({
                ...
                ,cols: [
                    [
                        ...
                        ,{field:'roomname', width:80, title: '房间名字'}
                        ,{field:'username', title: '评价人', sort: true}
