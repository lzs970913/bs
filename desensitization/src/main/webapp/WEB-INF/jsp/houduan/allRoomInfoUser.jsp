  ...
  <body>
    ...
    <div class="x-body">
      ...
      <table class="layui-table" lay-data="{width: 1000, height:332, url:'${pageContext.request.contextPath}/room/getAllRoomInfo.action', page:true, id:'idTest'}" lay-filter="demo">
        <thead>
        <tr>
          <th lay-data="{field:'id', width:140, sort: true, fixed: true}">房间编号</th>
          <th lay-data="{field:'name', width:140}">房间名</th>
          <th lay-data="{field:'price', width:120, sort: true}">房间价格</th>
          <th lay-data="{field:'description', width:200}">房间描述</th>
      ...
      <script type="text/html" id="barDemo">
        <a class="layui-btn layui-btn-xs" lay-event="edit">添加订单</a>
            ...
            table.on('tool(demo)', function(obj){
                ...
                if(obj.event === 'detail'){
                    ...
                    layer.open({
                        ...
                        ,maxmin: true
                        ,offset: 'auto'
                        ,content: '${pageContext.request.contextPath}/order/addOrderJSP/'+data.id+'.action'
                        ,yes: function(){
                            $(this).click();
                        }
                        ,btn2: function(){
